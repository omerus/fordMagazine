...
a)}function k(a){function b(a){this.name="TurnJsError";this.message=a}b.prototype=Error();b.prototype.constructor=b;return new b(a)}function v(){return""}var r="",n={down:"mousedown",move:"mousemove",up:"mouseup",over:"mouseover",out:"mouseout"},p={backward:["l"],forward:["r"],all:["l","r"]},x=["single","single"],y=["ltr","rtl"],z={acceleration:!0,display:"single",duration:600,page:1,gradients:!0,when:null},A={acceleration:!0,corners:"forward",cornerSize:300,duration:600,gradients:!0},i={init:function(a){if(1<
